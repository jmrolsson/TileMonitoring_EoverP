...
if tileESDMon:
    ...
    if (jobproperties.Beam.beamType() == 'collisions'):
        ...
        ToolSvc += CfgMgr.TileEoverPMonTool(name = 'TileEoverPMonTool'
                                            , OutputLevel = INFO
                                            ...
                                            , DoTrkExtrapolation = True
                                            , DoBasicTrkSelection = True
                                            , histoPathBase = "/Tile/EoverP")

        # Track selections for TileEoverPMonTool
        ToolSvc.TileEoverPMonTool.TrackSelectionTool.CutLevel = "LoosePrimary"
        ToolSvc.TileEoverPMonTool.TrackSelectionTool.minPt = 400
        ToolSvc.TileEoverPMonTool.TrackSelectionTool.maxAbsEta = 2.5
        ToolSvc.TileEoverPMonTool.TrackSelectionTool.maxD0 = 2.0
        ToolSvc.TileEoverPMonTool.TrackSelectionTool.maxZ0SinTheta = 3.0

        ManagedAthenaTileMon.AthenaMonTools += [ ToolSvc.TileEoverPMonTool ];
