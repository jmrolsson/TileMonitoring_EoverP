...
# Test Tile E/p Monitoring Tool
from TileMonitoring.TileMonitoringConf import TileEoverPMonTool
TileEoverPMonTool = TileEoverPMonTool(name = 'TileEoverPMon',
                                      OutputLevel = INFO,
                                      TrackContainerName = "InDetTrackParticles",
                                      CaloClusterContainerName = "CaloCalTopoClusters",
                                      CellContainerName = "AllCalo",
                                      TrackIsolationDeltaR = 0.4,
                                      TrackClusterMatchingDeltaR = 0.2,
                                      DoTrkExtrapolation = False,
                                      DoBasicTrkSelection = True,
                                      histoPathBase = "/Tile/EoverP")

# Track selections for TileEoverPMonTool
TileEoverPMonTool.TrackSelectionTool.CutLevel = "LoosePrimary"
TileEoverPMonTool.TrackSelectionTool.minPt = 400
TileEoverPMonTool.TrackSelectionTool.maxAbsEta = 2.5
TileEoverPMonTool.TrackSelectionTool.maxD0 = 2.0
TileEoverPMonTool.TrackSelectionTool.maxZ0SinTheta = 3.0

ToolSvc += TileEoverPMonTool;
ManagedAthenaTileMon.AthenaMonTools += [ TileEoverPMonTool ];
